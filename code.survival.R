...
survival_transf$dbh = scale(log(survival_transf$dbh))
survival_transf$P = scale(log(survival_transf$P))
survival_transf$N = scale(log(survival_transf$N))
survival_transf$la = scale(log(survival_transf$la))  
survival_transf$h = scale(log(survival_transf$h)) 
survival_transf$seed = scale(log(survival_transf$seed)) 
survival_transf$vla = scale(log(survival_transf$vla))
survival_transf$TNCI = scale(log(survival_transf$TNCI))
survival_transf$C = scale(survival_transf$C)  
survival_transf$c13 = scale(log(survival_transf$c13*-1))
survival_transf$log.lma = scale(log(survival_transf$lma))
...
sm2 = glmer(data = survival_transf, survival ~ log.lma + (1|quad) + (1|species),family=binomial(link=logit)) #lma
